...
from vindula.liberiuncontents.content.interfaces import IDownload
...
Download_schema = ATDocumentSchema.copy() + Schema((
    ...
    TextField(
            ...
            widget=RichWidget(
                ...
                rows="5",
                label_msgid='vindula_liberiuncontents_label_desc_button',
                description_msgid='vindula_liberiuncontents_help_desc_button',
    ...
    TextField(
            ...
            widget=StringWidget(
                ...
                label_msgid='vindula_liberiuncontents_label_title_info_comp',
                description_msgid='vindula_liberiuncontents_title_info_comp',
                i18n_domain='vindula_liberiuncontents',
            ),
        required=False,
    ),                                
    ...
    TextField(
            ...
            widget=RichWidget(
                ...
                description=_(u"Insira uma descrição para o botão de download."),
                rows="5",
                label_msgid='vindula_liberiuncontents_label_desc_info_comp',
                description_msgid='vindula_liberiuncontents_help_desc_info_comp',
                i18n_domain='vindula_liberiuncontents',
            ),
            required=False,
    ),
